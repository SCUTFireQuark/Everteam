...
@property (nonatomic, strong) UIAttachmentBehavior *dragAttachement;//依附，关联
@property (nonatomic, strong) UIDynamicAnimator *dynamicsAnimator;//动画
@property (nonatomic, strong) UICollisionBehavior *collisionBehavior;//碰撞检测
@end
