...
-(void)getRequest
{
    NSURL *url = [NSURL URLWithString:@"http://192.168.1.118/WebService.asmx/recordsInDataBase"];
...
-(void)startRequest:(STMemo *)MemoForSend
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://192.168.1.118/WebService.asmx/createMemo"];
